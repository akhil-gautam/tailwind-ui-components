export default {
  ...
  input: {
    base:
      'block w-full px-2 py-1 font-thin transition duration-200 focus:shadow-md focus:outline-none ring-offset-2',
  ...
  label: {
    base: 'block space-y-1 w-full text-gray-800 text-lg font-normal',
    default: '',
    outlined: 'p-4 rounded-xl border border-purple-600 transition hover:border-purple-800',
  },
};
