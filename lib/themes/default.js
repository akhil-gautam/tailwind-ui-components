export default {
  ...
  dropdown: {
    list: {
      base:
        'absolute w-64 p-2 mt-1 text-gray-700 font-medium text-base bg-white border border-gray-100 rounded-lg shadow-md min-w-max-content dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700',
    },
    item: {
      base:
