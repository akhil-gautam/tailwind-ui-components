export default {
  button: {
    default: {
      base:
        'px-6 py-2 rounded-lg shadow-lg focus:outline-none transition duration-400 ease-in-out hover:shadow-none focus:ring-2 ring-offset-1',
  ...
  list: {
    ...
    item: {
      base:
        'w-full px-6 py-4 bg-white rounded-xl shadow-lg transition duration-200 hover:shadow-none hover:bg-blue-100',
    },
  },
};
