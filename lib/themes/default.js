export default {
  ...
  transition: {
    fade: {
      appear: 'opacity-0',
      appearActive: 'opacity-100 transition-opacity duration-500 ease-in-out opacity-100',
      ...
      exitDone: 'transition-opacity duration-500 ease-in-out opacity-0',
    },
    grow: {
      appear: 'transform scale-0',
      appearActive: 'transform scale-100 transition-transform duration-500 ease-in-out',
      appearDone: 'transform scale-100',
      enter: 'transform scale-0',
      enterActive: 'transform scale-100 transition-transform duration-500 ease-in-out',
      enterDone: 'transform scale-100',
      exit: 'transform scale-100',
      exitActive: 'transform scale-0',
      exitDone: 'transition-transform duration-500 ease-in-out transform scale-0',
    },
